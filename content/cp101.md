...
Competitive Programming (CP, also known as Programming Challenges or Olympiad in Informatics) is practically a sport. It's heuristic.
  ...
  - International Collegiate Programming Contest (ICPC)
   ...
   - Google's Coding Competition
     ...
     - Code Jam, on the other hand, is overall more challenging and harder than Kick Start. There are multiple rounds where you need to pass the earlier ones to be qualified.
       The very first round is the Qualification Round (as per 2021, you are allowed to discuss each problem during this round) &#8594; Round 1 (1A/1B/1C &mdash; you may
...
- The joy of problem solving and that happy face when you smash it out of the park! 👀
    ...
    *Source: ["[Reaction] Moscow Takes the Lead!" on Youtube](https://www.youtube.com/watch?v=c71hlLuG1fM&ab_channel=ICPCNews)*
...
- Pick your programming language
  ...
  Try other language like Kotlin, Rust, Go for fun! Even [Gennady Korotkevich](https://en.wikipedia.org/wiki/Gennady_Korotkevich), arguably the greatest competitive programmer,
...
- Step 3: Be good at testing code and debugging, remember you are an artist!
...
## More on which and where to solve and compete:
  You can use [this site](https://clist.by/) to remind you of upcoming contests!
